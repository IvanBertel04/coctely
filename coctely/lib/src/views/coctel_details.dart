...
class CoctelDatails extends StatefulWidget {
  const CoctelDatails({super.key});

  @override
  State<StatefulWidget> createState() => _CoctelDatailsState();
}

class _CoctelDatailsState extends State<CoctelDatails>
